...
function parsePemCertificate(pemCertificate) {
    //console.log("parsePemCertificate");
...
function getTBSCertificateDER(certificate) {
    return rfc5280.TBSCertificate.encode(certificate.tbsCertificate, 'der');
}

module.exports = {parsePemCertificate, parseDerName, getSubjectPublicKeyInfoDER, getTBSCertificateDER};
